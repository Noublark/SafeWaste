...
def mostrar_tela_grafico(app, frame, frame2):

    global tela_grafico_frame

    frame.place_forget()
    frame2.place_forget()

    tela_grafico_frame = CTkFrame(master=app, width=500, height=400, corner_radius=15, border_color="")
    tela_grafico_frame.place(relx=0.5, rely= 0.5, anchor=CENTER)
    ...
    img_label_voltar.bind("<Button-1>", lambda event: voltar(app, tela_grafico_frame, img_label_voltar))
